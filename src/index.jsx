...
function Index() {
    ...
    useEffect(() => {
        fetchData("https://filpkart-db1.onrender.com/product-catagories", setcatagories);
        fetchData("https://filpkart-db1.onrender.com/carosuel", setcarousel);
        fetchData("https://filpkart-db1.onrender.com/Electronics", setElectronics);
        fetchData("https://filpkart-db1.onrender.com/toys", settoy);
        fetchData("https://filpkart-db1.onrender.com/healths", sethealth);
        fetchData("https://filpkart-db1.onrender.com/monsoons", setmonsoon);
        fetchData("https://filpkart-db1.onrender.com/monsoonstop", settop);
        fetchData("https://filpkart-db1.onrender.com/monsoonshome", sethome);
